...
class TestInvest(unittest.TestCase):
    ...
    def test_invest(self, case_list):
        ...
        sub_manager_user_tel = HandleContext.manager_user_tel(case_list_str)
        sub_manager_user_pwd = HandleContext.manager_user_pwd(sub_manager_user_tel)
        sub_borrower_user_id = HandleContext.borrower_user_id(sub_manager_user_pwd)
        sub_loan_id = HandleContext.loan_id(sub_borrower_user_id)
        sub_invest_user_tel = HandleContext.investors_user_tel(sub_loan_id)
        sub_invest_user_pwd = HandleContext.investors_user_pwd(sub_invest_user_tel)
        case_list_dict = eval(sub_invest_user_pwd)
